      ...
      <div class="max-w-md w-full">
        <div class="bg-[#001242] border-2 border-[#A68542] rounded-lg p-8">
          <div class="text-center mb-8">
            ...
            <p class="text-white mt-2">Access your company financing dashboard</p>
          </div>
          ...
          <div class="mt-6 text-center text-white">
            <p>
              ...
              <router-link to="/auth/borrower/register" class="font-medium text-[#A68542] hover:text-[#8B7355]">
                Register here
              </router-link>
            </p>
          </div>
